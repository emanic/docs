...
curl --silent -o concepts.md -H "Authorization: token ${GITHUB_TOKEN}" "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/next/concepts/_index.md"
curl --silent -o enforcer-policy-pcc.png -H "Authorization: token ${GITHUB_TOKEN}" "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/static/img/diagrams/enforcer-policy-pcc.png"
curl --silent -o authentication-pcc.png -H "Authorization: token ${GITHUB_TOKEN}" "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/static/img/diagrams/authentication-pcc.png"
curl --silent -o enforcer-tcp-pcc.png -H "Authorization: token ${GITHUB_TOKEN}" "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/static/img/diagrams/enforcer-tcp-pcc.png"
curl --silent -o pus.png -H "Authorization: token ${GITHUB_TOKEN}" "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/static/img/diagrams/pus.png"
