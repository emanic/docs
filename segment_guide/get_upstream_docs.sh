...
echo "Getting start: defender host"
curl --silent -o defender-host.md -H "Authorization: token ${GITHUB_TOKEN}" \
  "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/next/start/enforcer/linux/_index.md"

pandoc defender-host.md -o defender-host.adoc

gsed -i -e 's/^==/===/g' defender-host.adoc
gsed -i -e 's/\* _Y/pass:\[\*] _Y/g' defender-host.adoc

gsed -i -e '1 i\// WE PULL THIS CONTENT FROM https://github.com/aporeto-inc/junon\n// DO NOT EDIT THIS FILE.\n// YOU MUST SUBMIT A PR AGAINST THE UPSTREAM REPO.\n// THE UPSTREAM REPO IS CURRENTLY PRIVATE.\n\n== Linux or Windows host\n' \
  defender-host.adoc

rm -f defender-host.md
rm -f start/defender/defender-host.adoc
mv defender-host.adoc start/defender/defender-host.adoc
