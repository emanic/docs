...
echo "Getting concepts: basic"
curl --silent -o basic-concepts.md -H "Authorization: token ${GITHUB_TOKEN}" \
...
pandoc basic-concepts.md -o basic-concepts.adoc

gsed -i -e 's/^==/===/g' basic-concepts.adoc
gsed -i -e 's/\/img\/diagrams\//:/g' basic-concepts.adoc

gsed -i -e '1 i\// WE PULL THIS CONTENT FROM https://github.com/aporeto-inc/junon\n// DO NOT EDIT THIS FILE.\n// YOU MUST SUBMIT A PR AGAINST THE UPSTREAM REPO.\n// THE UPSTREAM REPO IS CURRENTLY PRIVATE.\n\n== Basic concepts\n' \
  basic-concepts.adoc

rm -f basic-concepts.md
rm -f concepts/basic-concepts.adoc
mv basic-concepts.adoc concepts/basic-concepts.adoc
...
gsed -i -e 's/^{{< svg file="ns-multi-tenant\.svg" >}}/image::ns-multi-tenant\.png\[width=900\]/g' namespaces.md
...
echo "Getting scale: multi-region"
curl --silent -o scale-multi-region.md -H "Authorization: token ${GITHUB_TOKEN}" \
  "https://raw.githubusercontent.com/aporeto-inc/junon/master/src/content/next/start/control-plane/multi-region/_index.md"

pandoc scale-multi-region.md -o scale-multi-region.adoc

gsed -i -e 's/^==/===/g' scale-multi-region.adoc

gsed -i -e '1 i\// WE PULL THIS CONTENT FROM https://github.com/aporeto-inc/junon\n// DO NOT EDIT THIS FILE.\n// YOU MUST SUBMIT A PR AGAINST THE UPSTREAM REPO.\n// THE UPSTREAM REPO IS CURRENTLY PRIVATE.\n\n== Deploy Segment Console across multiple regions (deprecated)\n' \
  scale-multi-region.adoc

rm -f scale-multi-region.md
rm -f scale/scale-multi-region.adoc
mv scale-multi-region.adoc scale/scale-multi-region.adoc
